...
# Helper: fetch README via GitHub API (raw.githubusercontent.com blocked in some regions)
fetch_readme() {
  local repo=$1
  curl -sf "https://api.github.com/repos/$repo/readme" | python3 -c "
...
TRAVISVN_SKILLS=$(fetch_readme "travisvn/awesome-claude-skills" | parse_awesome_list "travisvn" "travisvn/awesome-claude-skills" "9600")
...
BEHISECC_SKILLS=$(fetch_readme "BehiSecc/awesome-claude-skills" | parse_awesome_list "BehiSecc" "BehiSecc/awesome-claude-skills" "5600")
...
VOLTAGENT_SKILLS=$(fetch_readme "VoltAgent/awesome-agent-skills" | parse_awesome_list "VoltAgent" "VoltAgent/awesome-agent-skills" "")
...
ALIREZAREZVANI_SKILLS=$(fetch_readme "alirezarezvani/claude-skills" | parse_awesome_list "alirezarezvani" "alirezarezvani/claude-skills" "")
...
MXYHI_SKILLS=$(fetch_readme "mxyhi/ok-skills" | parse_awesome_list "mxyhi" "mxyhi/ok-skills" "188")
...
DAYMADE_SKILLS=$(fetch_readme "daymade/claude-code-skills" | parse_awesome_list "daymade" "daymade/claude-code-skills" "")
...
VERCEL_SKILLS=$(fetch_readme "vercel-labs/agent-skills" | python3 -c "
import sys, re, json
content = sys.stdin.read()
skills = []
...
VOLTAGENT_SUB_SKILLS=$(fetch_readme "VoltAgent/awesome-claude-code-subagents" | parse_awesome_list "VoltAgent-subagents" "VoltAgent/awesome-claude-code-subagents" "15557")
...
HEILCHENG_SKILLS=$(fetch_readme "heilcheng/awesome-agent-skills" | parse_awesome_list "heilcheng" "heilcheng/awesome-agent-skills" "3483")
...
HESREALLYHIM_SKILLS=$(fetch_readme "hesreallyhim/awesome-claude-code" | parse_awesome_list "hesreallyhim" "hesreallyhim/awesome-claude-code" "39900")
